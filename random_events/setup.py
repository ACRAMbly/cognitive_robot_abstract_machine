...
ext_modules = [
    Pybind11Extension(
        "random_events_lib",
        [
            "src/random_events_lib/export/bindings.cpp",
            "src/random_events_lib/random_events_lib/src/sigma_algebra.cpp",
            "src/random_events_lib/random_events_lib/src/set.cpp",
            "src/random_events_lib/random_events_lib/src/product_algebra.cpp",
        ],  # C++ binding source
        include_dirs=[
            "src/random_events_lib/random_events_lib/include"
