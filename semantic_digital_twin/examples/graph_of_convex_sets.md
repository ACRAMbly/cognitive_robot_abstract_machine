...
gcs = GraphOfBoundingBoxes.free_space_from_world(box_world, search_space=search_space)
```
...
gcs = GraphOfBoundingBoxes.free_space_from_world(world, search_space=search_space)
```
