...
class Handle(HasRootBody):
    ...
    def get_default_body_specification(
        ...
        *,
        ...
        """
        Build the default handle body specification, matching the hollow handle
        geometry generated by :meth:`create_with_new_body_in_world`.

        :param name: The name of bodies created from the specification.
        :param scale: The scale of the handle. Defaults to ``Scale(0.1, 0.02, 0.02)``.
        :param thickness: The thickness of the handle walls.
...
class Door(HasHandle, HasMechanicalJoint):
    ...
    def get_default_body_specification(
        ...
        solid box; the ``EntryWay`` region is spawn-time structure and is not part
...
class Floor(HasSupportingSurface):
    ...
    def get_default_body_specification(
        ...
        polytope geometry generated by :meth:`create_with_new_body_in_world`
        (which derives points from the scale bounding box).
...
class Wall(HasApertures):
    ...
    def get_default_body_specification(
        ...
        by :meth:`create_with_new_body_in_world` (a box whose z runs ``0..scale.z``).
