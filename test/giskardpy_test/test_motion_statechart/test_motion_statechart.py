...
def test_local_minimum_reached_only_depends_on_given_degrees_of_freedom(
    ...
    # torso_joint never moves (nothing commands it), so the scoped monitor should report
    # "settled" almost immediately despite r_wrist_roll_joint actively moving toward its
    # own target the whole time.
    kin_sim.tick_until_end(timeout=1000)
